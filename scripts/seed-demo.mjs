...
async function seed(userId) {
  ...
  await must(
    ...
    await supabase
      ...
      .update({
        ...
        terms_accepted_at: isoOffset(-14),
        ai_processing_accepted_at: isoOffset(-14),
        onboarding_completed_at: isoOffset(-13),
  ...
  await must(
    ...
    await supabase.from("documents").insert([
      ...
      { id: cnicId, user_id: userId, type: "identity_document", label: "CNIC (demo placeholder)" },
