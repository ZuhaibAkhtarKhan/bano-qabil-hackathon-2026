...
begin
  ...
  set
    ...
    work_authorization = 'Pakistan G현 eligible to intern locally',
  ...
  insert into public.documents (id, user_id, type, label) values
    ...
    (cnic_id, demo_id, 'supporting_document', 'CNIC (demo placeholder)'),
  ...
  insert into public.applications (
    ...
    (app_host, demo_id, opp_host, 'in_progress', now() + interval '6 days',
     'Waiting on host CAPTCHA. Complete it yourself G현 1-Apply will not click Submit.', null, 88, 'Asia/Karachi'),
  ...
  insert into public.eligibility_results (
    ...
    (demo_id, app_needs, req_needs, 'unclear', 'GPA is not in the kit yet G현 confirm it in Need You.', 'Minimum GPA 3.0', 'education', true);
  ...
  insert into public.notifications (
    ...
    (demo_id, app_deadline, opp_deadline, 'Deadline freeze in 2 days',
     'NUST-SEECS packet is complete. If you stay silent, 1-Apply will freeze it G현 it will not click host Submit.',
    ...
    (demo_id, app_submitted, opp_submitted, 'Packet frozen',
     'STEP intern snapshot is stored. Track the host G현 1-Apply did not send the form.',
