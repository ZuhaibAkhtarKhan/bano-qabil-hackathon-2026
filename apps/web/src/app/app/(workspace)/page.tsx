...
/**
 * Default home uses zuhaib's match/table dashboard.
 * Saadia's full packet/kit dashboard is preserved at
 * `@/components/app/dashboard-packets` (`DashboardPackets`) — not deleted.
 * Decide which should be the sole `/app` view.
 */
